...
!function(t, i, s) {
    function e(t, s) {
        ...
        this.enable(),
        i.addEventListener("touchmove", this._removeTouchmove, !!this.isPassive() && {
            capture: !1,
            passive: !1
        })
    }
    function o(t, s, e) {
        ...
        n.style.height = "100%"),
        o.className = "iScrollHorizontalScrollbar") : (e === !0 && (o.style.cssText += ";width:4px;bottom:2px;top:2px;right:1px",
        n.style.width = "100%"),
    ...
    var r = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function(i) {
      ...
      , h = function() {
        ...
        ,
        o.momentum = function(t, i, e, o, n, r, h) {
            var a, l, c = t - i, p = s.abs(c) / e;
            return r = void 0 === r ? 6e-4 : r,
            h = void 0 === h ? 0 : h,
            a = t + p * p / (2 * r) * (c < 0 ? -1 : 1),
            l = p / r,
            a < o ? (a = n ? o - n / 2.5 * (p / 8) : o,
            c = s.abs(a - t),
            l = c / p) : a > h && (a = h + (n ? n / 2.5 * (p / 8) : 0),
            c = s.abs(t) + a,
            l = c / p),
            {
    ...
    e.prototype = {
        ...
        destroy: function() {
            ...
            document.removeEventListener("touchmove",this._removeTouchmove,false)
        },
        ...
        _move: function(t) {
            var i = this.wrapperHeight
              , e = i - this.pointY;
            if (this.options.listLoading && (e < 0 || e > i) && this._end(t),
            this.enabled && h.eventType[t.type] === this.initiated) {
                this.options.preventDefault && t.preventDefault();
                var o, n, r, a, l = t.touches ? t.touches[0] : t, c = l.pageX - this.pointX, p = l.pageY - this.pointY, d = h.getTime();
                if (this.pointX = l.pageX,
                this.pointY = l.pageY,
                this.distX += c,
                this.distY += p,
                r = s.abs(this.distX),
                a = s.abs(this.distY),
                !(d - this.endTime > 300 && r < 10 && a < 10)) {
                    if (this.directionLocked || this.options.freeScroll || (r > a + this.options.directionLockThreshold ? this.directionLocked = "h" : a >= r + this.options.directionLockThreshold ? this.directionLocked = "v" : this.directionLocked = "n"),
                    ...
                    o = this.x + c,
                    n = this.y + p,
                    (o > this.minScrollX || o < this.maxScrollX) && (o = this.options.bounce ? this.x + c / 3 : o > this.minScrollX ? this.minScrollX : this.maxScrollX),
                    (n > this.minScrollY || n < this.maxScrollY) && (n = this.options.bounce ? this.y + p / 3 : n > this.minScrollY ? this.minScrollY : this.maxScrollY),
                    ...
                    this.moved = !0,
                    this._translate(o, n),
                    d - this.startTime > 300 && (this.startTime = d,
                    this.startX = this.x,
                    this.startY = this.y,
        ...
        _end: function(t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                !this.resetPosition(this.options.bounceTime)) {
                    ...
                    if (this.options.momentum && o < 300 && (i = this.hasHorizontalScroll ? h.momentum(this.x, this.startX, o, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration, this.minScrollX) : {
                        destination: n,
                        duration: 0
                    },
                    e = this.hasVerticalScroll ? h.momentum(this.y, this.startY, o, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration, this.minScrollY) : {
                        destination: r,
                        duration: 0
                    },
                    n = i.destination,
        ...
        resetPosition: function(t) {
            var i = this.x
              , s = this.y;
            return t = t || 0,
            !this.hasHorizontalScroll || this.x > this.minScrollX ? i = this.minScrollX : this.x < this.maxScrollX && (i = this.maxScrollX),
        ...
        scrollTo: function(t, i, s, e) {
            ...
            !s || this.options.useTransition && e.style ? (this._transitionTimingFunction(e.style),
        ...
        _transitionTime: function(t) {
            if (t = t || 0,
            this.scrollerStyle[h.style.transitionDuration] = t + "ms",
            !t && h.isBadAndroid && (this.scrollerStyle[h.style.transitionDuration] = "0.001s"),
            this.indicators)
        ...
        _translate: function(t, i) {
            if (!this.pullDownFlg && (this.options.useTransform ? this.scrollerStyle[h.style.transform] = "translate(" + t + "px," + i + "px)" + this.translateZ : (t = s.round(t),
            i = s.round(i),
    ...
    n.prototype = {
        ...
        _move: function(t) {
            var i, s, e, o, n = t.touches ? t.touches[0] : t, r = h.getTime();
        ...
        transitionTime: function(t) {
            t = t || 0,
            this.indicatorStyle[h.style.transitionDuration] = t + "ms",
            !t && h.isBadAndroid && (this.indicatorStyle[h.style.transitionDuration] = "0.001s")
        },
